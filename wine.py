...
if st.button('Wine Quality Prediction Result'):
    wine_prediction = winequality_model.predict([[FixedAcidity, VolatileAcidity, CitricAcidity, ResidualSugar, FreeSulfurDioxide, Density, Sulphate, Alcohol, Chloride]])
